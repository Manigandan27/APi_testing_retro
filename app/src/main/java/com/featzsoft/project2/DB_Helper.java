...
public class DB_Helper {
    public class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void addUser(ModelClass user) {
...
/*
//        public void Login_Insert(String username, String password, String imei)
//        {
//            SQLiteDatabase db = this.getWritableDatabase();
...
//            cv.put("IMEI", imei);
//            db.insert("Login", "USERNAME", cv);
//            db.close();
//        }
*/

        public void updateUser(ModelClass user) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        public void deleteUser(ModelClass user) {
            SQLiteDatabase db = this.getWritableDatabase();
